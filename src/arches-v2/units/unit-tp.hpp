...
protected:
	...
	uint finished_threads = 0;
	uint num_threads;
	uint current_thread_id{ ~0u };
	bool last_cycle_data_stalling = false;
	bool last_cycle_resource_stalling = false;
...
protected:
	void data_stall_switch_thread();
	void resource_stall_switch_thread();
